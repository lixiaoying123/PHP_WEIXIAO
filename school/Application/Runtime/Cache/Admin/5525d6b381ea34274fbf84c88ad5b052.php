...
<html>
<head>
     <link href="/school1/Public/Admin/js/bootstrap.min.css" rel="stylesheet">
   <script src="/school1/Public/Admin/js/jquery.min.js"></script>
   <script src="/school1/Public/Admin/js/bootstrap.min.js"></script>
    <meta charset="UTF-8">
...
<h3><strong>基本信息：</strong></h3>
   <table class="table table-condensed">
                ...
                <tr>              
	              ...
	              <td width="82%" class="word_grey"><?php echo ($info["admin_name"]); ?></td>
	            </tr>
				<tr>              
	              <td width="18%" height="30" align="center">真实姓名：</td>
	              <td width="82%" class="word_grey"><?php echo ($info["admin_tname"]); ?></td>
	            </tr>
				<tr>
	              <td height="28" align="center">学院：</td>
	              <td height="28"><?php echo ($info["admin_class"]); ?></td>
	            </tr>
	            <tr>
		          <td height="28" align="center">QQ：</td>
		          <td height="28"><?php echo ($info["admin_qq"]); ?></td>
	            </tr>
	            <tr>
	              <td height="28" align="center">E-mail：</td>
	              <td height="28"><?php echo ($info["admin_email"]); ?></td>
	            </tr>
	        </table>				
