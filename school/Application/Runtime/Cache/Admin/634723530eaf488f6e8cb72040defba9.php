...
<body>
<form class="form-inline definewidth m20" action="/school1/index.php/Admin/user/frontlist" method="get">
    ...
    <button type="button"  id="addnew" onclick="window.location.replace('/school1/index.php/Admin/user/group')">群发消息</button>
</form>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <?php foreach($list as $key => $value){ if($value[count]==1){ $value[count]='被禁言'; }else{ $value[count]='';} ?>
        <tr>
            ...
            <td><a href="/school1/index.php/Admin/user/frontmessage/user_id/<?php echo ($value["user_id"]); ?>"><button type="submit">发送</button></a></td>
            <td><a href="/school1/index.php/Admin/user/frontdelete/user_id/<?php echo ($value["user_id"]); ?>"><button type="submit">删除</button></a></td>
        </tr>
    <?php } ?>
