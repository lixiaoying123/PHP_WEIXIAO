...
<body>
	<form class="form-inline definewidth m20" action="/school1/index.php/Admin/lost/lostquery" method="get">
		...
		<button type="button"  id="addnew">
			<a href="/school1/index.php/Admin/lost/lostadd.html">添加物品
		</button>
		</a>
	</form>
	<table class="table table-bordered table-hover definewidth m10">
		...
		<tr>
			...
			<td>
				<a href="/school1/index.php/Admin/Lost/delete/lost_id/<?php echo ($value["lost_id"]); ?>"><button type="submit">删除</button></a>
			</td>
