            ...
            <form action="/school1/index.php/Home/Goods/add" method="post" enctype="multipart/form-data">
              <table>
                <ul >
                    ...
                    <li>
                        商品名称：<input name="goods_name" class="required" type="text" />
                    </li>
                    </br></br>
                    <li>
                        商品价格：<input name="goods_price" type="text"/>
                    </li>
                    </br></br>
                    <li>

                        商品种类：<input name="goods_type"  type="radio" value="1"  />学习
                        <input name="goods_type"  type="radio" value="2" />电子
                        <input name="goods_type"  type="radio" value="3" />生活
                        <input name="goods_type"  type="radio" value="4" />其他

                    </li>
                    </br></br>
                    <li>

                        QQ：<input name="goods_qq"  type="text" />


                    </li>
                    </br></br>
                    <li>
                        TEL：<input name="goods_tel"  type="text" />
                    </li>
                    </br></br>
                    <li>

                        商品图片：<input name="goods_img"  type="file" name="photo1"/>
