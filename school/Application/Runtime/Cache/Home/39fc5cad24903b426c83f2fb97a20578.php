...
<section id="show_cases" style="background-image:url(/school1/Public/Home/images/login.jpg);background-size:cover;-moz-background-size:cover;-webkit-background-size:cover;">
    <div class="cat_title">
        <div class="wrapper">
            <h2 style="color: black;"><strong>GRADE</strong>成绩</h2>
            <p style="color:#333;">我的成绩<br/>Our grade... </p>
        </div>
    </div>
    <article>
        <div class="wrapper">
            ...
            <div style="text-align: center;color:#232323;">
                <?php echo (getVerify_cj($img)); ?>
                <form enctype="multipart/form-data" action=/school1/index.php/Home/Grade/login method="post" style="margin-top: 20px;height: 280px;">
                    <div class="mui-input-row" style="opacity:0.5;color: white;width: 80%; margin: auto 10% auto">
                       <lable style="font-size: 20px;">学年：</lable><select name="ddlXN" class="input-text" style="width:100px;">
                        ...
                        <lable style="font-size: 20px;">学期：</lable><select name="ddlXQ" class="input-text" style="width:100px;">
                       ...
                       <br/>
                        ...
                        <div class="mui-input-row" style="opacity:0.5;color: white;width: 80%; margin: auto 10% auto">
                           ...
                           <div class="mui-input-row" style="opacity:0.5;color: white;width: 80%; margin: auto 10% auto">
                            ...
                            <img src="/school1/Public/verifyCode2.jpg"></span>
                          </div>
                          <br/>
