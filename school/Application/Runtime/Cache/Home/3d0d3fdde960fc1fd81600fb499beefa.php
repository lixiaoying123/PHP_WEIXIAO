...
<section id="caseslist">
    <div class="cat_title">
        <div class="wrapper">
            <h2><strong>self</strong>我的商品</h2>
            <p>自己的商品<br/>
                Our work... </p>
            <a href="/school1/index.php/Home/Goods/add">添加</a>
        </div>
    </div>
    <!--<div id="filter">
        <div class="wrapper">
            <table width="1000px" border="0" align="center">
                <form action="/school1/index.php/Home/Goods/self" method="post" >
                    <tr id="header">
    ...
    <ul class="cases wrapper">
        ...
        <li class="item1"> <img src="/school1/Public/<?php echo ($value["goods_img"]); ?>" tppabs=""  width="240" height="152" alt="<?php echo ($value["goods_name"]); ?>" /> <strong></strong>
            ...
            <p> <strong><?php echo ($value["goods_name"]); ?> </strong> <em>QQ：<?php echo ($value["goods_qq"]); ?><br/>
                ...
                <a href="/school1/index.php/Home/Goods/goodsdetail?id=<?php echo ($value["goods_id"]); ?>" tppabs="http://mc18.eatdou.com/case/gov/22.html" class="btn_blue">查看商品详情</a> </p>
        </li>
