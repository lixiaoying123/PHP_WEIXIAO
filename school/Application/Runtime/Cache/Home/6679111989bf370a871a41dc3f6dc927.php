                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <table>
                        <ul >
                            ...
                            <li>
                                商品名称：<input name="goods_name" class="required" type="text" value="<?php echo ($info["goods_name"]); ?>"/>
                            </li>
                            </br></br>
                            <li>
                                商品价格：<input name="goods_price" class="required" type="text" value="<?php echo ($info["goods_price"]); ?>"/>
                            </li>
                            </br></br>
                            <li>
                                ...
                                商品种类：
                               <?php
 if($info[goods_type]==’study‘){ echo '<input name="goods_type"  type="radio" value="study" checked/>学习'; echo '<input name="goods_type"  type="radio" value="dianzi" />电子'; echo '<input name="goods_type"  type="radio" value="life" />生活'; echo '<input name="goods_type"  type="radio" value="other" />其他'; }else if($info[goods_type]=='dianzi'){ echo '<input name="goods_type"  type="radio" value="study" />学习'; echo '<input name="goods_type"  type="radio" value="dianzi" checked/>电子'; echo '<input name="goods_type"  type="radio" value="生活" />生活'; echo '<input name="goods_type"  type="radio" value="other" />其他'; }else if($info[goods_type]=='life'){ echo '<input name="goods_type"  type="radio" value="study" />学习'; echo '<input name="goods_type"  type="radio" value="dianzi" />电子'; echo '<input name="goods_type"  type="radio" value="life" checked/>生活'; echo '<input name="goods_type"  type="radio" value="other" />其他'; }else{ echo '<input name="goods_type"  type="radio" value="study" />学习'; echo '<input name="goods_type"  type="radio" value="dianzi" />电子'; echo '<input name="goods_type"  type="radio" value="life" />生活'; echo '<input name="goods_type"  type="radio" value="other" checked/>其他'; } ?>
                            </li>
                            </br></br>
                            <li>

                                QQ：<input name="goods_qq"  type="text" value="<?php echo ($info["goods_qq"]); ?>"/>
                            ...
                            <li>
                                ...
                                TEL：<input name="goods_tel"  type="text" value="<?php echo ($info["goods_tel"]); ?>"/>
                            ...
                            <li>
                                ...
                                <img src="/school1/Public/<?php echo ($info["goods_img"]); ?>" tppabs=""  width="240" height="152" />
                                </br>
                                <input name="goods_img1"  type="file"/></br></br>
                                <img src="/school1/Public/<?php echo ($info["goods_img1"]); ?>" tppabs=""  width="240" height="152" />


                            </li>
                            </br></br>
                            <li>
                                商品详情：<textarea rows="3" cols="30" name="goods_detail"><?php echo ($info["goods_detail"]); ?></textarea>
                            </li>
