                    ...
                    <table>
                        <ul >
                            ...
                            <li>
                                ...
                                商品种类：
                               <?php
 if($info[goods_type]==1){ echo '<input name="goods_type"  type="radio" value="1" checked/>学习'; echo '<input name="goods_type"  type="radio" value="2" />电子'; echo '<input name="goods_type"  type="radio" value="3" />生活'; echo '<input name="goods_type"  type="radio" value="4" />其他'; }else if($info[goods_type]==2){ echo '<input name="goods_type"  type="radio" value="1" />学习'; echo '<input name="goods_type"  type="radio" value="2" checked/>电子'; echo '<input name="goods_type"  type="radio" value="3" />生活'; echo '<input name="goods_type"  type="radio" value="4" />其他'; }else if($info[goods_type]==3){ echo '<input name="goods_type"  type="radio" value="1" />学习'; echo '<input name="goods_type"  type="radio" value="2" />电子'; echo '<input name="goods_type"  type="radio" value="3" checked/>生活'; echo '<input name="goods_type"  type="radio" value="4" />其他'; }else{ echo '<input name="goods_type"  type="radio" value="1" />学习'; echo '<input name="goods_type"  type="radio" value="2" />电子'; echo '<input name="goods_type"  type="radio" value="3" />生活'; echo '<input name="goods_type"  type="radio" value="4" checked/>其他'; } ?>
                            </li>
                            </br></br>
                            <li>
