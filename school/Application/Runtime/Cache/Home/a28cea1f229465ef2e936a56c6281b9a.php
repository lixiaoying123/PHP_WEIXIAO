...
<section id="caseslist">
    <div class="cat_title">
        <div class="wrapper">
            ...
            <p class="leftmenu" style="float: right;">
                <a href="/school1/index.php/Home/Lost/add">添加物品</a>
                <a href="/school1/index.php/Home/Lost/self/user_id/<?php echo ($userid); ?>">我的物品</a>
            </p>
        </div>
    </div>
    <div id="filter">
        <div class="wrapper">
            <table width="1000px" border="0" align="center">
                <form action="/school1/index.php/Home/lost/lostlist?timeup%25252525253Dtimeup" method="get" >
                    <tr id="header">
    ...
    <ul class="cases wrapper">
        ...
        <li class="item1"> 
        <?php if($value[lost_img]==null){ echo "<img src='/school1/Public/$value[lost_img1]' tppabs=''  width='240' height='152' alt='$value[lost_name]' />"; }else{ echo "<img src='/school1/Public/$value[lost_img]' tppabs=''  width='240' height='152' alt='$value[lost_name]' />";}?>
         <strong></strong>
