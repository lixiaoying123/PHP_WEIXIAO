...
<section id="show_cases">
    <div class="cat_title">
        <div class="wrapper">
            <h2><strong>CASES</strong>商品</h2>
            <p>我们的作品，它们的故事<br/>Our work, their stories </p>
            <input type="hidden" name='id' value="<?php echo ($_GET['id']); ?>" />
            <a href="/school1/index.php/Home/Goods/update/goods_id/<?php echo ($info[0][goods_id]); ?>">修改</a>
            <a href="/school1/index.php/Home/Goods/delete/goods_id/<?php echo ($info[0][goods_id]); ?>">删除</a>
        </div>
    </div>
    <article>
        <div class="wrapper">
            <div id="overview">
                ...
                <div id="case_info">
                    ...
                    <h1><img src="/school1/Public/<?php echo $info[0][goods_img] ?>" tppabs="" width="180" height="120" alt="商品" /></h1>
                    <ul>
            ...
            <div id="detailed">
                <img alt="" src="/school1/Public/<?php echo $info[0][goods_img] ?>" tppabs="" style="height: 499px; width: 700px;" />
                <img alt="" src="/school1/Public/<?php echo $info[0][goods_img] ?>" tppabs="" />
                <img alt="" src="/school1/Public/<?php echo $info[0][goods_img] ?>" tppabs="" />
            </div>
        </div>
    </article>
